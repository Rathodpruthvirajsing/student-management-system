            ...
            <?php if (count($teachers) > 0) {
                foreach ($teachers as $teacher) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?php echo $teacher['id']; ?>" class="btn btn-edit" title="Edit"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="delete.php?id=<?php echo $teacher['id']; ?>" class="btn btn-delete" title="Delete" onclick="return confirm('Delete this teacher?');"><i class="fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
                <?php }
            } else { ?>
